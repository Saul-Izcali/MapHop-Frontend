...
export class TablaDesatendidosComponent implements OnInit {
  ...
  filtradoOrdenamientos(){
    console.log("entro al filtrado")
  ...
  // nuevoOrden(ordenamientosFiltrados: any){
  //   this.modal.open(ordenamientosFiltrados,{size:'lg',centered:true});
  // }
  ...
  filtradoTipoSegunUsr(){
    ...
    mapa() {
      ...
      loader.load().then(() => {
        ...
        // CREO QUE YA NO SE OCUPA LO DE ABAJO
